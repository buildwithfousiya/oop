#Abstraction: showing only the necessary details and hiding the complex background

from abc import ABC, abstractmethod  #abc:library name, ABC: class name
class Employee(ABC):
...
full_time_emp = FullTimeEmployee("tom", "e87", 60000)
part_time_emp = PartTimeEmployee("arun", "t78", 20, 100)
